 ...
 */
public class ListOrgaRolesAdapter extends Adapter<Role>{
    protected boolean isShowDelete;
    private boolean isDeleteShow;
    private OnItemDeleteListener listen;

    public ListOrgaRolesAdapter(@Nullable List<Role> data, @NonNull int... layoutResIds) {
    ...
    @Override
    protected void convert(AdapterHelper helper, Role role) {
        helper.setText(R.id.module_list_title, StringUtils.filteEmpty(role.getTitle()))
                .setText(R.id.module_list_desc, StringUtils.filteEmpty(role.getDescription()))
        ...
        Picasso.with(App.app).load(PicloadManager.orgaServiceIconUrl(role.getId()))
